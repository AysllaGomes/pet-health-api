...
\restrict uZ4td14HmKwqcXjMiTx6Vgv07joYYTAtDEoBmVy6GQ5czD2HJnhepve4UNxxtey
...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:9FIbETK16l1scIL9HHXvBA==$tC2eCFy1EupFXYOKvusHI9kvNmRY3oOuAXUr0nTjDWg=:IDgkl/+Qxh/fSvhtD2XJz6dz0JArqPbDeGtL0pZqzd0=';
...
\unrestrict uZ4td14HmKwqcXjMiTx6Vgv07joYYTAtDEoBmVy6GQ5czD2HJnhepve4UNxxtey
...
\restrict ecaavkyyIvSK7iypuDRwfjR3YqRwJCrL9D8xOoQgTejfaxb70jzTZj5ytYqfund
...
\unrestrict ecaavkyyIvSK7iypuDRwfjR3YqRwJCrL9D8xOoQgTejfaxb70jzTZj5ytYqfund

--
-- Database "pet_health" dump
--
...
\restrict prsD4JufxwAb7PQ5sCgbhemK1QX2fzvoSD3jMS491FJ8JNnAtu9E6VrM3LZmiiS
...
--
-- Name: pet_health; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE pet_health WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE pet_health OWNER TO postgres;

\unrestrict prsD4JufxwAb7PQ5sCgbhemK1QX2fzvoSD3jMS491FJ8JNnAtu9E6VrM3LZmiiS
\connect pet_health
\restrict prsD4JufxwAb7PQ5sCgbhemK1QX2fzvoSD3jMS491FJ8JNnAtu9E6VrM3LZmiiS
...
\restrict YOwacNeAqY6h7BYyzRfBSKzVx7iWm5AuAJqhvfyvQCoNzW2FexFMcyoECanfpqQ
...
\unrestrict YOwacNeAqY6h7BYyzRfBSKzVx7iWm5AuAJqhvfyvQCoNzW2FexFMcyoECanfpqQ
